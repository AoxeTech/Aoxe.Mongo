            ...
            if (node.NodeType == ExpressionType.Decrement)
            {
                ...
                switch (nodeTypeCode)
                {
                    ...
                    case TypeCode.Decimal:
                        ...
                        break;
                    default:
                        throw new NotSupportedException($"Not support type {node.Type} of field named \"{_fieldName}\"");
                }
            }
            ...
            if (node.Type.IsArray)
            {
                switch (node.Type.Name)
                {
                    ...
                    case "Int64[]":
                        ...
                        break;
                    default: throw new NotSupportedException("This array type is not supported");
                }
            }
            else
            {
